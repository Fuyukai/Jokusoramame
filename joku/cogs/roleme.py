...
class Roleme(Cog):
    async def on_guild_role_delete(self, role: discord.Role):
        ...
        await self.bot.rethinkdb.remove_roleme_role(role.guild, role)
    ...
    async def roleme(self, ctx: Context, *, role: discord.Role = None):
        ...
        """
        roles = await ctx.bot.rethinkdb.get_roleme_roles(ctx.guild)
        if role is None:
    ...
    async def add(self, ctx: Context, *, name: str):
        ...
        await ctx.bot.rethinkdb.add_roleme_role(ctx.guild, role)
    ...
    async def disable(self, ctx: Context, *, role: discord.Role):
        ...
        """
        await ctx.bot.rethinkdb.remove_roleme_role(ctx.guild, role)
    ...
    async def colourme(self, ctx: Context, *, colour: discord.Colour):
        ...
        """
        enabled = await ctx.bot.rethinkdb.get_setting(ctx.guild, "colourme_enabled", {"value": False})
        ...
        await ctx.bot.rethinkdb.set_colourme_role(ctx.author, role)
    ...
    async def enable(self, ctx: Context):
        ...
        """
        await ctx.bot.rethinkdb.set_setting(ctx.guild, "colourme_enabled", value=True)
    ...
    async def disable(self, ctx: Context):
        ...
        """
        await ctx.bot.rethinkdb.set_setting(ctx.guild, "colourme_enabled", value=False)
